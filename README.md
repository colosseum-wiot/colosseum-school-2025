# Colosseum Young Gladiators 2025
### June 2-4, 2025
...
- Once the Colosseum account has been received, users are expected to go through the [Getting Started](https://colosseumwireless.readthedocs.io/en/latest/getting_started/index.html#) steps.
